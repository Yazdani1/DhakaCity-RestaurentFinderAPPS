...
public class GulsanCustomAdapter extends BaseAdapter {
    ...
    public GulsanCustomAdapter(GulsanActivity gulsanmain, String[] text, int[] img){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        View myview=inflater.inflate(R.layout.custom_culshan_list,null);
